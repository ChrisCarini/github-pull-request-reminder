...
<th>First comment at</th><td>${firstComment?.created_at} <i>(by ${firstComment?.user?.name})</i></td>
<th># of Approvals</th><td>${prApprovals.length}</td>
<th>First Approval at</th><td>${firstApproval.submitted_at} <i>(by ${firstApproval?.user?.name})</i></td>
